...
def bureau_and_balance(num_rows = None, nan_as_category = True):
    bureau = pd.read_csv('../Kaggle data/bureau.csv', nrows = num_rows)
    bb = pd.read_csv('../Kaggle data/bureau_balance.csv', nrows = num_rows)
...
def previous_applications(num_rows = None, nan_as_category = True):
    prev = pd.read_csv('../Kaggle data/previous_application.csv', nrows = num_rows)
...
def pos_cash(num_rows = None, nan_as_category = True):
    pos = pd.read_csv('../Kaggle data/POS_CASH_balance.csv', nrows = num_rows)
...
def installments_payments(num_rows = None, nan_as_category = True):
    ins = pd.read_csv('../Kaggle data/installments_payments.csv', nrows = num_rows)
...
def credit_card_balance(num_rows = None, nan_as_category = True):
    cc = pd.read_csv('../Kaggle data/credit_card_balance.csv', nrows = num_rows)
